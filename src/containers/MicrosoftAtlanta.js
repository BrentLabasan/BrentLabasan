    ...
    return (
      <div className="portfolioEntry Microsoft_Atlanta" style={{ textAlign: 'center' }}>
        ...
        <Grid>
          ...
          <Row className="show-grid">
            <Col xs={12} className="noPadding"><img src="/microsoft-atlanta/Thriftbooks-banner-lrg.jpg" alt="Thriftbooks banner" /></Col>
          </Row>
          ...
          <Row className="show-grid">
            <Col xs={12} className="F7CF87in"><img style={{ width: '100%' }} src="/microsoft-atlanta/Microsoft_Atlanta-traffic-autocomplete.png" alt="autocomplete traffic" /></Col>
          </Row>
          ...
          <Row className="show-grid">
            <Col xs={12} className="F7CF87in"><img style={{ width: '100%' }} src="/microsoft-atlanta/USPS-validation-modal.png" alt="USPS validation modal" /></Col>
          </Row>
          ...
          <Row className="show-grid">
            <Col xs={12} className="F7CF87in"><img style={{ width: '100%' }} src="/microsoft-atlanta/USPS-validation-modal-code.png" alt="USPS validation modal code" /></Col>
          </Row>
          ...
          <Row className="show-grid">
            <Col xs={12} className="F7CF87in"><img style={{ width: '100%' }} src="/microsoft-atlanta/USPS-validation-modal-bug-fixing-cleanup.png" alt="USPS validation modal" /></Col>
          </Row>
          ...
          <Row className="show-grid">
            <Col xs={12} className="F7CF87in"><img style={{ width: '100%' }} src="/microsoft-atlanta/Microsoft_Atlanta-traffic-USPS-modal.png" alt="USPS validation modal" /></Col>
          </Row>
          ...
          <Row className="show-grid">
            <Col xs={12} className="F7CF87in"><img style={{ width: '100%' }} src="/microsoft-atlanta/Thriftbooks-edition-selector-old-bw.jpg" alt="Thriftbooks banner" /></Col>
          </Row>
          ...
          <Row className="show-grid">
            <Col xs={12} className="F7CF87in"><img style={{ width: '100%' }} src="/microsoft-atlanta/Thriftbooks-edition-selector-new-bw.jpg" alt="Thriftbooks banner" /></Col>
          </Row>
          ...
          <Row className="show-grid">
            <Col xs={12} className="F7CF87in"><img style={{ width: '100%' }} src="/microsoft-atlanta/Thriftbooks-blog.jpg" alt="Thriftbooks blog entries" /></Col>
          </Row>
          ...
          <Row className="show-grid">
            <Col xs={12} className="F7CF87in"><img style={{ width: '100%' }} src="/microsoft-atlanta/Thriftbooks-Optimizely1.png" alt="Optimizely code and result" /></Col>
          </Row>
          ...
          <Row className="show-grid">
            <Col xs={12} className="F7CF87in"><img style={{ width: '100%' }} src="/microsoft-atlanta/Thriftbooks-LINQ.jpg" alt="LINQ queries" /></Col>
          </Row>
